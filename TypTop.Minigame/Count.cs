...
namespace TypTop.MinigameEngine
{
    public class Count : Entity
    {
        ...
        /// <summary>
        ///     De kleur die de cijfers van Count moet gebruiken als de countdown klaar is met aftellen. Standaardwaarde is
        ///     donkerrood.
        /// </summary>
        ...
        public Count(int seconds, Vector2 position, Game game) : base(game)
        {
            ...
            if (seconds != 0) _dateTime = _startTime.AddSeconds(seconds);
        ...
        /// <summary>
        ///     Geeft aan of de countdown klaar is met aftellen. Standaardwaarde is false. Werkt niet wanneer de Count gebruikt
        ///     wordt als stopwatch.
        /// </summary>
        ...
        /// <summary>
        ///     Het aantal seconden dat de countdown nog moet voordat deze klaar is met aftellen. In het geval van een stopwatch
        ///     gelijk aan SecondsSpent.
        /// </summary>
        public int Seconds =>
            (int) (_dateTime == null
                ? DateTime.Now.Subtract(_startTime)
                : ((DateTime) _dateTime).Subtract(DateTime.Now)).TotalSeconds;
        ...
        {
            DateTime dt = _dateTime ?? _startTime;
            ...
            if (ShowHours) sb.Append($"{("0" + timeSpan.Hours).Substring(timeSpan.Hours < 10 ? 0 : 1, 2)}:");
            sb.Append(
                $"{("0" + timeSpan.Minutes).Substring(timeSpan.Minutes < 10 ? 0 : 1, 2)}:{("0" + timeSpan.Seconds).Substring(timeSpan.Seconds < 10 ? 0 : 1, 2)}");
            ...
            if (_dateTime != null && (int) timeSpan.TotalSeconds < 0) Finished = true;

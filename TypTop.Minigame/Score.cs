...
namespace TypTop.MinigameEngine
{
    public class Score : Entity
    {
        ...
        /// <summary>
        ///     De richting waarop een FloatingScore zal zweven zodra er een verandering in de score optreedt. Standaardwaarde is
        ///     None, er zal geen FloatingScore weergegeven worden.
        /// </summary>
        ...
        /// <summary>
        ///     De kleur die de FloatingScore moet gebruiken als er een negatieve verandering in de score optreedt. Standaardwaarde
        ///     is donkerrood.
        /// </summary>
        public SolidColorBrush Negative = Brushes.DarkRed;

        /// <summary>
        ///     De kleur die de FloatingScore moet gebruiken als er een positieve verandering in de score optreedt. Standaardwaarde
        ///     is donkergroen.
        /// </summary>
        ...
        /// <summary>
        ///     Match de positie van de FloatingScore met de beide rechter uiteindes van de Score en FloatingScore. Standaardwaarde
        ///     is false.
        /// </summary>
        ...
        /// <summary>
        ///     Roept eerst UpdateText() aan en maakt vervolgens een nieuwe instantie aan van FloatingScore wanneer het verschil
        ///     niet 0 is en er een Direction ingesteld is. Kan alleen opgeroepen worden door de score bij te werken via Amount.
        /// </summary>
        /// <param name="diff">
        ...
        private void DisplayDifference(int diff)
        {
            ...
            {
                var fScore = new FloatingScore(diff, this)
                {
                    ZIndex = ZIndex + 1,
                ...
                if (Right)
                    fScore.LabelTransformX += (float) _labelComponent.Width -
                                              (float) fScore.GetComponent<LabelComponent>().Width;
